routerAdd(
  'POST',
  '/backend/v1/integracao/ac/run-round-2d2a-r10',
  (e) => {
    ...
    if (!EXECUTION_ENABLED) {
      return e.json(200, {
        build_status: 'READY',
        runner: 'R10',
        route: '/backend/v1/integracao/ac/run-round-2d2a-r10',
        executed: false,
      })
    }
    ...
    var correlationKey = 'TESTE-2D2A-R10-' + ts + '-' + nonce
    ...
    var POSITIVE_CONTROL_PAYLOAD = {
      ...
      contact: {
        ...
        firstName: '[TESTE]',
        lastName: 'R10PositiveControl',
        email: 'teste-r10-pc@teste.local',
        phone: '+5511999999999',
      },
    }
      ...
      if (overallStatus === 'PASS') {
        var t7Payload = {
          ...
          contact: {
            ...
            firstName: '[TESTE]',
            lastName: 'R10MissingSig',
            email: 'teste-r10-sm@teste.local',
            phone: '+5511999999999',
          },
        }
        ...
        t7.payload_is_full_semantic_copy =
          'Exact copy of positive control payload (contact_create) with IDs swapped to R10 correlation key'
        t7.timestamp_note =
      ...
      if (overallStatus === 'PASS' && mode === 'full') {
        ...
        if (overallStatus === 'PASS') {
          var up = sign({
            ...
            deal: {
              id: dealExtId,
              title: '[TESTE] R10 Full Atualizado',
              value: 15000,
        ...
        if (overallStatus === 'PASS') {
          ...
          if (dV3) {
            try {
              ...
              dealRestored =
                negRec.getString('titulo') === '[TESTE] R10 Full Negocio' &&
