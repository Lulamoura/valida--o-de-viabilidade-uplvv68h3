routerAdd(
  ...
  (e) => {
    ...
    var correlationKey = 'TESTE-2D2A-R11-' + ts + '-' + nonce
      ...
      if (overallStatus === 'PASS') {
        var t7Payload = {
          ...
          contact: {
            ...
            firstName: '[TESTE]',
            lastName: 'R11MissingSig',
            email: 'teste-r11-sm@teste.local',
            phone: '+5511999999999',
          },
        }
        ...
        t7.payload_is_full_semantic_copy =
          'Exact copy of positive control payload (contact_create) with IDs swapped to R11 correlation key'
        t7.timestamp_note =
      ...
      if (overallStatus === 'PASS') {
        var t8Payload = {
          ...
          contact: {
            ...
            firstName: '[TESTE]',
            lastName: 'R11InvalidSig',
            email: 'teste-r11-is@teste.local',
            phone: '+5511999999999',
          },
        }
        ...
        t8.payload_is_full_semantic_copy =
          'Exact copy of positive control payload (contact_create) with IDs swapped to R11 correlation key; signature header present but tampered'
      ...
      if (overallStatus === 'PASS' && mode === 'full') {
        ...
        if (overallStatus === 'PASS') {
          var up = sign({
            ...
            deal: {
              id: dealExtId,
              title: '[TESTE] R11 Full Atualizado',
              value: 15000,
        ...
        if (overallStatus === 'PASS') {
          ...
          if (dV3) {
            try {
              ...
              dealRestored =
                negRec.getString('titulo') === '[TESTE] R11 Full Negocio' &&
