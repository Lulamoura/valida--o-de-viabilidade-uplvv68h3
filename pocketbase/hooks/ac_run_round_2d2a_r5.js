routerAdd(
  'POST',
  '/backend/v1/integracao/ac/run-round-2d2a-r5',
  (e) => {
    ...
    var correlationKey = 'TESTE-2D2A-R5-' + ts + '-' + nonce
      ...
      if (overallStatus === 'PASS' && mode === 'full') {
        ...
        if (overallStatus === 'PASS') {
          var up = sign({
            ...
            deal: {
              id: dealExtId,
              title: '[TESTE] R5 Full Atualizado',
              value: 15000,
        ...
        if (overallStatus === 'PASS') {
          ...
          if (dV3) {
            try {
              ...
              dealRestored =
                negRec.getString('titulo') === '[TESTE] R5 Full Negocio' &&
