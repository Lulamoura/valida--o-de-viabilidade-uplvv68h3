routerAdd(
  'POST',
  '/backend/v1/integracao/ac/run-round-2d2a-r7',
  (e) => {
    ...
    var correlationKey = 'TESTE-2D2A-R7-' + ts + '-' + nonce
    ...
    try {
      ...
      if (overallStatus === 'PASS') {
        ...
        var t7Body = JSON.stringify(t7BodyObj)
      ...
      if (overallStatus === 'PASS' && mode === 'full') {
        ...
        if (overallStatus === 'PASS') {
          var up = sign({
            ...
            deal: {
              id: dealExtId,
              title: '[TESTE] R7 Full Atualizado',
              value: 15000,
        ...
        if (overallStatus === 'PASS') {
          ...
          if (dV3) {
            try {
              ...
              dealRestored =
                negRec.getString('titulo') === '[TESTE] R7 Full Negocio' &&
